...
def generate3x3():
    ...
    for num in range(1,10):
        ...
        # . . . | . . . | . . . 
        try:
            sudoku = set3x3(sudoku, block1, num)
        except TypeError:
            break
        ...
        # . . . | . . . | . . . 
        try:
            sudoku = set3x3(sudoku, block2, num)
        except TypeError:
            break
        ...
        # . . . | . . . | . . . 
        try:
            sudoku = set3x3(sudoku, block3, num)
        except TypeError:
            break
        ...
        # . . . | . . . | . . . 
        try:
            sudoku = set3x3(sudoku, block4, num)
        except TypeError:
            break
        ...
        # . . . | . . . | . . . 
        try:
            sudoku = set3x3(sudoku, block5, num)
        except TypeError:
            break
        ...
        # . . . | . . . | . . . 
        try:
            sudoku = set3x3(sudoku, block6, num)
        except TypeError:
            break
        ...
        # 0 0 0 | . . . | . . . 
        try:
            sudoku = set3x3(sudoku, block7, num)
        except TypeError:
            break
        ...
        # . . . | 0 0 0 | . . . 
        try:
            sudoku = set3x3(sudoku, block8, num)
        except TypeError:
            break
        ...
        # . . . | . . . | 0 0 0 
        try:
            sudoku = set3x3(sudoku, block9, num)
        except TypeError:
            break
